...
test_that("check_and_tidy_date_first_last works with valid inputs", {
    check_and_tidy_date_first_last <- rbc:::check_and_tidy_date_first_last
...
test_that("check_parallel works with valid inputs", {
    check_parallel <- rbc:::check_parallel
...
test_that("check_res_status_after_and_person_id works with valid inputs", {
    check_res_status_after_and_person_id <- rbc:::check_res_status_after_and_person_id
...
test_that("check_res_status_initial_and_res_status_after works with valid inputs", {
    check_res_status_initial_and_res_status_after <- rbc:::check_res_status_initial_and_res_status_after
