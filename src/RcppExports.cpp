...
RcppExport SEXP _rbc_days_in_country_internal(SEXP date_crossingSEXP, SEXP is_arrivalSEXP, SEXP n_crossing_personSEXP, SEXP date_obs_endSEXP, SEXP dur_testSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _rbc_is_long_term_mig_internal(SEXP is_arrivalSEXP, SEXP res_status_beforeSEXP, SEXP res_status_afterSEXP, SEXP days_in_countrySEXP, SEXP days_obsSEXP, SEXP dur_testSEXP, SEXP dur_thresholdSEXP, SEXP n_crossing_personSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< IntegerVector >::type is_arrival(is_arrivalSEXP);
...
RcppExport SEXP _rbc_person_id_internal(SEXP personIdSEXP, SEXP personId_is_naSEXP, SEXP match1SEXP, SEXP match2SEXP, SEXP first_idSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _rbc_res_status_after_internal(SEXP res_status_initialSEXP, SEXP is_arrivalSEXP, SEXP days_in_countrySEXP, SEXP days_obsSEXP, SEXP n_crossing_personSEXP, SEXP dur_testSEXP, SEXP dur_thresholdSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_rbc_days_in_country_internal", (DL_FUNC) &_rbc_days_in_country_internal, 5},
    {"_rbc_is_long_term_mig_internal", (DL_FUNC) &_rbc_is_long_term_mig_internal, 8},
    {"_rbc_person_id_internal", (DL_FUNC) &_rbc_person_id_internal, 5},
    {"_rbc_res_status_after_internal", (DL_FUNC) &_rbc_res_status_after_internal, 7},
    {NULL, NULL, 0}
};

RcppExport void R_init_rbc(DllInfo *dll) {
